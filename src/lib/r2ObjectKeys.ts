...
export const R2_MEDIA_PREFIX_BY_ROLE = {
  ...
  'profiles.gallery-image': 'media/profiles/gallery-images',
  'profiles.profile-image': 'media/profiles/profile-images',
  'screen-appearances.body-image': 'media/screen-appearances/body-images',
  'screen-appearances.profile-image': 'media/screen-appearances/profile-images',
  'screen-appearances.thumbnail': 'media/screen-appearances/thumbnails',
...
const R2_MEDIA_FILENAME_BASE_BY_ROLE: Record<R2MediaRole, string> = {
  ...
  'profiles.gallery-image': 'profile-gallery-image',
  'profiles.profile-image': 'profile-image',
  'screen-appearances.body-image': 'screen-appearance-body-image',
  'screen-appearances.profile-image': 'screen-appearance-profile-image',
  'screen-appearances.thumbnail': 'screen-appearance-thumbnail',
