...
type ProfileProductionIndexItem = {
  id: string
  title: string
}

type ProfileProductionIndexProps = {
  items: ProfileProductionIndexItem[]
}

export function ProfileProductionIndex({ items }: ProfileProductionIndexProps) {
      ...
      {items.map((item) => {
        ...
        return (
          <SmoothAnchorLink
            ...
            className={[
              'section-profile-production-list__nav-link group relative inline-flex w-fit items-center py-1 type-label-m font-semibold transition-[color,padding] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-brand',
