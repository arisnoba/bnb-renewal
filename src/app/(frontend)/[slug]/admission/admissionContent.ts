...
const examTuitionTables: ContentTable[] = [
  {
    ...
    rows: [
      ...
      {
        composition: '주 4회, 월 48시간, 회당 3시간, 모의고사, 주말반 운영',
        course: '예비입시반',
        fee: '600,000원/월',
        target: '고등학교 2학년 연영과 진학 희망자',
      },
      {
        composition: '주 4회, 월 48시간, 회당 3시간, 모의고사, 주말반 운영',
        course: '예고입시반',
        fee: '750,000원/월',
        target: '예술고등학교 진학 희망자 ',
      },
    ],
    title: '수강료',
  },
...
const highteenTuitionTables: ContentTable[] = [
  ...
  },
  {
    ...
    minWidth: 720,
    rows: [
      { course: '청소년반', day: '주중 2회 (월목 / 화금)', duration: '420분', fee: '450,000원' },
      { course: '청소년반', day: '주말 1회 (토)', duration: '330분', fee: '350,000원' },
      { course: '청소년반', day: '주말 1회 (일)', duration: '330분', fee: '350,000원' },
    ],
    title: '수업 시간대 및 수강료',
  },
  {
