...
const usageFaqHref = '/art/faq?category=etc'
...
const services: ServiceItem[] = [
  ...
  },
  {
    ...
    description:
      '아트센터 1층 DID에서 영화 라인업에 관한 정보 및 현재 진행중인 영화의 시놉시스를 확인하실 수 있습니다.',
    icon: 'camera-movie',
    id: 'movie-synopsis',
  ...
  },
  {
    ...
    description:
      '아트센터 1층 DID에서 국내 주요 광고모델 에이전시 50여 곳의 정보를 확인하실 수 있습니다.',
    icon: 'billboard',
    id: 'agency-list',
  ...
  },
  {
    ...
    description:
      '배우앤배움 아트센터 교육팀은 매주 토요일마다 새로 준비한 배배대본(주간 오디션 대본)을 제공해드립니다.',
    icon: 'newspaper',
    id: 'weekly-script',
    title: '배배대본 배포 서비스',
  },
  ...
  },
  {
    ...
    description:
      '아트센터 1층 안내데스크 로비에 설치된 PC를 통해 수업 자료나 대본 등 희망하시는 출력물을 인쇄할 수 있습니다.',
    icon: 'print',
    id: 'print',
    title: '학생 프린트 서비스',
  },
  {
    ...
    description: '아트센터 1층 안내데스크에서는 매거진 <씨네21>을 이용하실 수 있습니다.',
    icon: 'books',
    id: 'cine21',
    title: '씨네21 잡지 비치',
  },
