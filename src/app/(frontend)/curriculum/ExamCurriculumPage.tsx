...
const examCurriculumTabs: ExamCurriculumTab[] = [
  ...
  },
  {
    ...
    roadmap: [
      { period: '2월~5월', step: '1단계', title: '기초 연기 훈련' },
      { period: '6월~10월', step: '2단계', title: '중급 연기 훈련' },
      { period: '11월~1월', step: '3단계', title: '연기심화 및 작품구성연습' },
      { period: '다음해 2월', step: '입시반 승급', title: '승급 테스트' },
    ],
    tracks: [
      {
        badge: '예비 입시반',
  ...
  return (
    <main className="page page-dark page-curriculum page-curriculum--exam bg-[#0C0C0C]" data-center="exam">
      <section
        ...
        className="section-kv-hero section-kv-hero--standard section-exam-curriculum-hero"
        data-page-tone="dark"
      >
        <PageHeroImage image={getEducationHeroImage('exam')} />
        <div aria-hidden="true" className="absolute inset-0 bg-black/72" />
        <PageDeco
          className="-left-24 top-[48%] md:-left-56 lg:-left-72"
