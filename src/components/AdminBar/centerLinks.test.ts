...
test('adminBarCenterHref keeps the current center page when the target center supports it', () => {
  ...
  assert.equal(adminBarCenterHref('/art/direct-castings', 'kids'), '/kids/direct-castings')
  assert.equal(
    adminBarCenterHref('/art/direct-castings/sample-project', 'highteen'),
    '/highteen/direct-castings/sample-project',
  )
  assert.equal(adminBarCenterHref('/art/company', 'kids'), '/kids/company')
  assert.equal(adminBarCenterHref('/art/consult', 'exam'), '/exam/consult')
  assert.equal(adminBarCenterHref('/art/curriculum', 'avenue'), '/avenue/curriculum')
  assert.equal(adminBarCenterHref('/art/curriculum', 'exam'), '/exam/curriculum')
  assert.equal(adminBarCenterHref('/art/curriculum', 'kids'), '/kids/curriculum')
  assert.equal(adminBarCenterHref('/art/curriculum/basic-class', 'avenue'), '/avenue/curriculum/basic-class')
  assert.equal(adminBarCenterHref('/art/grade-system', 'avenue'), '/avenue/grade-system')
  assert.equal(adminBarCenterHref('/exam/management', 'exam'), '/exam/management')
  assert.equal(adminBarCenterHref('/exam/passed-reviews/student-a', 'exam'), '/exam/passed-reviews/student-a')
})
...
test('adminBarCenterHref sends unsupported center pages to the target center main', () => {
  ...
  assert.equal(adminBarCenterHref('/art/casting-status', 'exam'), '/exam')
  assert.equal(adminBarCenterHref('/art/casting-system', 'exam'), '/exam')
  assert.equal(adminBarCenterHref('/art/direct-castings', 'exam'), '/exam')
